...
namespace CustomerMaintenance
{
    public partial class frmCustomerMaintenance : Form
    {
        ...
        private void ClearControls()
        {
            ...
            txtState.Text = "";
            txtZipCode.Text = "";
			//Keeps the user from being able to modify or delete the customer since this is only called when a customer is not found.
        ...
        private void DisplayCustomer()
        {
			...
			//Allows the user to modify or delete the customer since this is called when a customer is found.
